  ...
  return (
    <section className='homeproducts font-rubik'>
      <div className='container'>
        ...
        <div className='homeproducts__slider'>
          <div className='homeproducts__slider-container' style={{ transform: `translateX(-${(slideRef.current?.clientWidth * activeIdx) + (30 * activeIdx)}px)` }}>
            {products.map((prd, i) => (
              <div
                ref={slideRef}
                key={i}
